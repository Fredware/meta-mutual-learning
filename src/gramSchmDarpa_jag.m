function [chans loss] = gramSchmDarpa_jag(X, Z, mvts, maxChans, varargin)
...
possChans = corrChanSelZeroMeanDarpa_jag(X,Z,1:size(X,1),corrKineThresh,size(Z,1),windowType);
